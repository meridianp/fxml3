...
class TestApp(TestWrapper, TestClient):
    ...
    def continuousFuturesOperations_req(self):
        ...
        timeStr = datetime.datetime.now(datetime.timezone.utc).strftime(
            "%Y%m%d-%H:%M:%S"
        )
    ...
    def orderBound(self, orderId: int, apiClientId: int, apiOrderId: int):
        ...
        print(
            ...
            intMaxString(orderId),
            "ApiClientId:",
            intMaxString(apiClientId),
            "ApiOrderId:",
            intMaxString(apiOrderId),
        )
    ...
    def rfqOperations(self):
        ...
        # ! [rfq_submission]
        self.placeOrder(
            self.nextOrderId(), ContractSamples.BondWithCusip(), OrderSamples.Rfq()
        )
        # ! [rfq_submission]
