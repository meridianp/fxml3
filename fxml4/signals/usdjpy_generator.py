"""
Simple ML Signal Generator for USDJPY
...
class USDJPYSignalGenerator:
    def __init__(self):
        self.model_path = (
            "/home/cnross/code/fxml4/models/USDJPY/rf_model_20250618_220826.joblib"
        )
        self.model = None
        self.symbol = "USDJPY"
...
usdjpy_signal_generator = USDJPYSignalGenerator()


def generate_usdjpy_signal(features: pd.DataFrame) -> Dict[str, Any]:
    """Global function to generate USDJPY signal."""
    return usdjpy_signal_generator.generate_signal(features)
