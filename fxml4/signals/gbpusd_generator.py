"""
Simple ML Signal Generator for GBPUSD
...
class GBPUSDSignalGenerator:
    def __init__(self):
        self.model_path = (
            "/home/cnross/code/fxml4/models/GBPUSD/best_model_lightgbm.joblib"
        )
        self.model = None
        self.symbol = "GBPUSD"
...
gbpusd_signal_generator = GBPUSDSignalGenerator()


def generate_gbpusd_signal(features: pd.DataFrame) -> Dict[str, Any]:
    """Global function to generate GBPUSD signal."""
    return gbpusd_signal_generator.generate_signal(features)
