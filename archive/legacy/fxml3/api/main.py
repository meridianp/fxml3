            ...
            "waves": [
                {
                    ...
                    "end_idx": 100,
                    "subwaves": [
                        {"wave_num": 1, "start_idx": 0, "end_idx": 20, "price_range": [1.0800, 1.0850]},
                        {"wave_num": 2, "start_idx": 20, "end_idx": 30, "price_range": [1.0850, 1.0825]},
                        {"wave_num": 3, "start_idx": 30, "end_idx": 70, "price_range": [1.0825, 1.0900]},
                        {"wave_num": 4, "start_idx": 70, "end_idx": 80, "price_range": [1.0900, 1.0875]},
                        {"wave_num": 5, "start_idx": 80, "end_idx": 100, "price_range": [1.0875, 1.0925]}
                    ]
                }
            ],
...
async def get_task_status(
    ...
    return {
        ...
        "data": {
            ...
            "result": result,
            "created_at": datetime.utcnow().isoformat(),
            "estimated_completion_time": datetime.utcnow() + timedelta(minutes=1) if status == "processing" else None
        },
        "meta": {
            "timestamp": datetime.utcnow().isoformat(),
            "version": "1.0"
