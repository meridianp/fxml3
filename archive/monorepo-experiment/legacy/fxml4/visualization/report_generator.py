...
try:
    ...
    logger.warning("Missing dependencies for report generation. Install jinja2 and matplotlib.")
...
def create_performance_report(
    ...
    if not trades_df.empty and 'entry_time' in trades_df.columns:
        trades_df = trades_df.sort_values('entry_time', ascending=False).head(20)  # Show last 20 trades
    ...
    html = template.render(
        ...
        monthly_returns_table=dataframe_to_html(metrics.monthly_returns) if hasattr(metrics, 'monthly_returns') else "",
