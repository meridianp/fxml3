...
class ElliottWaveKnowledgeBase:
    ...
    def seed_basic_knowledge(self) -> Dict[str, bool]:
        ...
        basics = [
            ...
            },
            {
                ...
                """,
                "metadata": {"category": "fibonacci", "source": "measurement_techniques"}
            },
            {
                "text": """
                Wave Counting Rules:
            ...
            },
            {
                ...
                """,
                "metadata": {"category": "multi_timeframe", "source": "fractal_structure"}
            },
            {
                "text": """
    ...
    def add_category_knowledge(
        ...
        if category not in self.CATEGORIES:
            raise ValueError(f"Unrecognized category: {category}. Valid categories: {list(self.CATEGORIES.keys())}")
    ...
    def load_from_directory(self, directory_path: str) -> Dict[str, any]:
        ...
        for category in self.CATEGORIES:
            ...
            for file_path in category_path.glob("*.txt"):
                ...
                try:
                    ...
                    response = self.add_category_knowledge(
        ...
        if total_documents > 0:
            result["success"] = True
            result["message"] = f"Successfully loaded {total_documents} documents from {len(result['categories'])} categories"
        else:
