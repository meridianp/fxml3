...
class TimeframeAggregator:
    ...
    def aggregate_to_timeframes(self, 
        ...
        for target_tf in target_timeframes:
            ...
            if target_minutes > base_minutes:
                ...
                logger.warning(f"Cannot aggregate from {base_timeframe} to {target_tf} (higher resolution)")
    ...
    def calculate_mtf_indicators(self,
                               price_data_dict: Dict[str, pd.DataFrame]) -> Dict[str, Dict[str, pd.Series]]:
        ...
        for timeframe, data in price_data_dict.items():
            ...
            indicators['support_levels'] = self._find_support_resistance(data, 'support')
            indicators['resistance_levels'] = self._find_support_resistance(data, 'resistance')
    ...
    def align_timeframe_data(self,
                           price_data_dict: Dict[str, pd.DataFrame],
                           reference_time: Optional[datetime] = None) -> Dict[str, pd.DataFrame]:
