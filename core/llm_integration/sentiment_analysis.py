"""Market sentiment analysis for forex trading.

This module provides sentiment analysis capabilities for forex markets
by extracting and analyzing news from various sources. It integrates with
the trading system to provide additional context for trading decisions.
"""
...
class MarketSentimentAnalyzer:
    ...
    def __init__(
        ...
        if cache_dir:
            ...
            # Default to ~/.fxml4/cache/sentiment
            home_dir = os.path.expanduser("~")
            self.cache_dir = os.path.join(home_dir, ".fxml4", "cache", "sentiment")
