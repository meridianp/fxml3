...
class CSVDataFeed(DataFeed):
    ...
    def _get_file_path(self, symbol: str, timeframe: str) -> Optional[str]:
        ...
        """
        # Check cache first
        if symbol in self._available_files and timeframe in self._available_files[symbol]:
    ...
    def get_historical_data(
        ...
        if file_path is None:
            raise FileNotFoundError(f"CSV file for {symbol} with timeframe {timeframe} not found")
